...
<html lang="en">
  ...
  <body>
    <div
      class="container-fluid py-2 border-bottom d-none d-lg-block bg-primary"
    >
      <div class="container">
        <div class="row">
          <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center">
              <a class="text-decoration-none text-body pe-3" href=""
                ><i class="bi bi-telephone me-2"></i>+012 345 6789</a
              >
              <span class="text-body">|</span>
              <a class="text-decoration-none text-body px-3" href=""
                ><i class="bi bi-envelope me-2"></i>@.com</a
              >
            </div>
          </div>
          <div class="col-md-6 text-center text-lg-end">
            <div class="d-inline-flex align-items-center">
              <a class="text-body px-2" href="Logout.php"> Logout </a>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
              ...
              <a href="appointment.php" class="nav-item nav-link"
                >Appointment</a
              >
        ...
        >
          <div class="col-lg-8">
            <div class="bg-white rounded p-5 m-5 mb-0">
              <form action="https://formsubmit.co/mangeshkanojia580@gmail.com" method="POST">
                <div class="row g-3">
