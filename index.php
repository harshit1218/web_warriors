        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-body px-2" href="Logout.php">
                            Logout  
                        </a>
        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    ...
                    <h1 class="display-1  mb-md-4">Best Healthcare Solution In Your City</h1>
                    <div class="pt-2">
            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/mental health.webp" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
...
<div class="container" id="bmi">
            ...
            <div class="box">
                ...
                <div class="footer"><a class="footer-text" target="_blank"></a></div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed by <a class="text-primary" href="">Web</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
     ...
     <script>
            ...
            var toggle=()=>{
                ...
                document.getElementByClass("user-box").classList.toggle("view")
            }
